...
/** @var \CodeHuiter\Pattern\Module\Auth\Model\UserInterface $userPreview */
?>
<a href="<?=$those->links->user($userPreview)?>" class="bodyajax user-item">
	<img class="preview" src="<?=$those->media->store('user_medias', $userPreview->getPicturePreview())?>" alt="<?=$those->userService->getPresentName($userPreview)?>"/>
