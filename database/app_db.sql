...
--
-- Хост: localhost
-- Время создания: Июл 24 2018 г., 16:24
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  KEY `alias` (`alias`(191)),
  KEY `login` (`login`(191))
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8mb4 COMMENT='Пользователи';
...
(50, '&lt;scripterOK/&gt;', 'abc74db4a14d3861bcdcb1e1d3ffeb83', '04b4008dff584313afb290905327d3b9', 'password_a8a382c13bb119b50f90865ce691f1bd', '2013-08-24 20:54:23', 1532380622, 1532407742, '[1,2,3,5,6]', '84.201.231.69', '-180', 0, 0, 'default/profile_nopicture.png', 'default/profile_nopicture.png', 'default/profile_nopicture_preview.png', 0, 'ourtravelru@gmail.com', 1, 0, '', '', '', '', '', '', '[]', '', 'scripterOK', '', '', '', '1920-01-01', 1, '', -500, -500, 'О себе тут', 0, 0, '{\"person_description\":\"хелло\"}');
